...
const LoginModalInner: React.FC<ILoginModalProps> = ({open, close, tryAuth}) => {
    let captcha: any
    ...
    return (
        <div className="blocker" onClick={() => close()}>
            <div id="ex1" className="modal position-relative" onClick={(event) => event.stopPropagation()}>
                ...
                <div className="login_right">
                    ...
                    <div className="login_box1">
                        <form className="auth_form" onSubmit={handleSubmit(onSubmit)} noValidate={true}>
                            <div className={inputValues.email ? "auth_input-wrapper hasValue" : "auth_input-wrapper"}>
                                <input
                                    type="email"
                                    // placeholder="Email"
                                    name="email"
                                    className={`auth_input ${errors.email ? "auth_input-error" : ""}`}
                            ...
                            <div
                                className={inputValues.password ? "auth_input-wrapper hasValue" : "auth_input-wrapper"}
                            >
                                <img
                                    className="eye"
