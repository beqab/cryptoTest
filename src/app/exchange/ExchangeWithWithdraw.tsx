...
export interface IExchangeWithWithdrawProps extends IExchangeProps, IConsumerAuth, IConsumerModal { }
...
const ExchangeWithWithdrawInner: React.FC<IExchangeWithWithdrawProps> = ({
    ...
    const [hasAnswerToExchange, setHasAnswerToExchange] = useState<boolean>(false);
    ...
    const label = currencies.find((item) => item.value === selectedCurrency)!.label;
                            ...
                            <div className="exchangeView">
                                ...
                                <div className="exchangeView-body">
                                    <div className="exchangeView-body-commission">
                                        ...
                                        <div className="value">
                                            {(Number(value) / 100 * exchangeEUR.changePercent).toFixed(2)} EUR
              </div>
                                    ...
                                    <div className="getPay">
                                        <b>Pay</b>
                                        <b>{Number(value) - Number((Number(value) / 100 * exchangeEUR.changePercent).toFixed(2))} EUR</b>
                                    </div>
                        ...
                        <p>Loading ...</p>
                                ...
                                <>
                                    <p style={{ color: "#006EDA" }} className="text-center">
                                        {exchangeStatus ? "Successfully Exchanged" : exchangeErrorMessage || "Something went wrong"}
                                    </p>
                                    <button
                                        className="sell_button"
                                        style={{ maxWidth: 230 }}
            ...
            <div className="content_l1">
                ...
                <div className="content_l1-background">
                    <div className={`content_l1-inputs ${cryptoToCurrency ? "content_l1-inputs-reverse" : ""}`}>
                        ...
                        <div
                            style={{ display: "flex", justifyContent: "space-between", marginTop: 10, marginBottom: 10 }}
                        >
                ...
                <div style={{ marginTop: 40 }}>
                    <div className="data_update">
                        <div className="data_update-box">
                            <div className="home_block3_title3">Data is Update Every Ten Second</div>
                            <div style={{ width: 50 }}>
                                <CircularProgressbarWithChildren minValue={0} maxValue={10} value={10 - diffUpdate}>
                    ...
                    <div className={`home_block3${exchangeUSD.last === 0 ? " block-loading" : ""}`}>
                        <div className="">
                            <div className="home_block3_title">USD</div>
                            <div className="home_block3_title1 btc-usd">{utilNumbers.floor(exchangeUSD.last)}</div>
                        </div>
                        ...
                        <div className="">
                            <div className={`home_block2_title4 ${exchangeUSD.changePercent < 0 ? "red" : "green"}`}>
                                {`${exchangeUSD.changePercent < 0 ? "" : exchangeUSD.changePercent > 0 ? "+" : ""} ${exchangeUSD.changePercent
                                    }`}
                                %
                            </div>
                        </div>
                    </div>
                    <div className={`home_block3${exchangeEUR.last === 0 ? " block-loading" : ""}`}>
                        <div className="">
                            <div className="home_block3_title">EUR</div>
                            <div className="home_block3_title1 btc-eur">{utilNumbers.floor(exchangeEUR.last)}</div>
                        </div>
                        <div className="home_block3_title3">Change over the period</div>
                        <div className="">
                            <div className={`home_block2_title4 ${exchangeEUR.changePercent < 0 ? "red" : "green"}`}>
                                {`${exchangeEUR.changePercent < 0 ? "" : exchangeEUR.changePercent > 0 ? "+" : ""} ${exchangeEUR.changePercent
                                    }`}
                                %
                            </div>
                        </div>
