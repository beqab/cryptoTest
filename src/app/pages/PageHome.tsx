...
export interface IPageHomeProps extends RouterProps, IConsumerAuth, IConsumerModal {}

const PageHomeInner: React.FC<IPageHomeProps> = ({isLoggedIn, history, open}) => {
    if (isLoggedIn) {
        ...
        <div className="PageHome">
            ...
            <div className="PageHome-top">
                <div className="PageHome-top-left">
                    ...
                    <span className="PageHome-top-left-description">
                        We made it fast and easy <br /> Founded in 2019 by the group of crypto entrepreneurs and
                        enthusiasts, CryptoIEX is the premier Estonia - based blockchain platform, providing
            ...
            <div className="PageHome_firstSection ">
                ...
                <div className="PageHome_firstSection-content">
                    ...
                    <p>
                        Secure platform – Cryptoiex employs the most reliable, effective security technologies
                        available. We keep to offer customer friendly solutions and most profitable rates.
                    </p>
                    <p>
                        Also, Cryptoiex enables two-factor authentication for all users and provides a host of
                        additional security features to provide multiple layers of protection. At Cryptoiex, security
                        will always be a top priority in every decision we make.
                    </p>
